                ...
                <div class="card card-plain mt-8">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <!-- 第一個 Radio Button: 素食 -->
                            <input type="radio" class="form-check-input me-2 custom-radio" name="dietaryPreference" v-model="dietaryRestrictions" id="nonVegetarian" :value="true" />
                            <label for="nonVegetarian" class="form-check-label me-4">素食</label>
                            <!-- 第二個 Radio Button: 葷食 -->
                            <input type="radio" class="form-check-input me-2 custom-radio" name="dietaryPreference" v-model="dietaryRestrictions" id="vegetarian" :value="false"/>
...
.custom-radio {
    accent-color: #007bff; /* 設置邊框顏色為藍色，調整為你希望的顏色 */
    outline: 2px solid #007bff; /* 設置選中時的外框顏色 */
    outline-offset: 2px; /* 控制外框與元素間的距離 */
    transition: outline 0.2s ease-in-out; /* 增加過渡效果 */
}

.custom-radio:checked {
    outline: 2px solid #ff5722; /* 勾選時的顏色，可以調整 */
}
</style>
