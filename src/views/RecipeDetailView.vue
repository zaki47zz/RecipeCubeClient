  ...
  if (source === "buyAndCook") {
    ...
    return cookingStore.cookingInventories.map((inventory) => {
      ...
      const requiredQuantity =
        recipeStore.selectedRecipe?.ingredientQuantities[ingredientId] || 0;
...
const startCooking = async () => {
  try {
    const {
      deletedIngredients = [],
      updatedIngredients = [],
    } = await updateInventoriesAfterCooking(recipeIngredients.value);
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <span v-else-if="recipeStore.selectedRecipe.visibility === 1"
                  >群組公開</span
                >
