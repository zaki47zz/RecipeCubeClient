...
const startCooking = async () => {
    try {
        const { deletedIngredients = [], updatedIngredients = [] } = await updateInventoriesAfterCooking(recipeIngredients.value);
...
<template>
    <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span v-else>未知</span> <!-- 若為意外值，顯示"未知" -->
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="container-fluid">
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-4">
                            <ul class="list-unstyled">
                                <li v-for="(ingredient, index) in recipeIngredients" :key="ingredient.ingredientId"
                                    class="mb-1">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <!-- Checkbox，綁定 checked 狀態和 localChecked 集合 -->
                                        <el-checkbox :value="isChecked(ingredient.ingredientId)"
                                            @change="toggleChecked(ingredient.ingredientId)" class="mt-2">
                                        </el-checkbox>
                                        <!-- 顯示食材名稱與數量資訊 -->
                                        <span :style="{
                                            textDecoration: localChecked.includes(ingredient.ingredientId) ? 'line-through' : 'none',
                                        }" class="ms-2">
                                            {{ ingredient.ingredientName }} - 需求數量: {{ ingredient.requiredQuantity }} {{
                                                ingredient.unit }}
                                            (庫存總數量:
                                            <span :class="{
                    ...
                    <div class="col-12">
                        ...
                        <div class="seasoning-tags mt-3"
                            style="display: flex; flex-wrap: wrap; justify-content: center">
                            <el-tag v-for="(seasoning, index) in seasoningList" :key="index" type="primary"
                                effect="light" size="large" class="mb-2 me-3">
                                {{ seasoning }}
                            </el-tag>
                        </div>
                    </div>
        ...
        <section class="mt-6 text-center">
            ...
            <div class="recipe-steps my-4 wide-steps-container d-flex justify-content-center"
