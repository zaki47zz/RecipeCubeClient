...
const API_URL = `${import.meta.env.VITE_API_BASEURL}/EmailVerification/ForgetPassword`;
const user = ref({
    email: '',
});
const send = async () => {
...
<template>
    ...
    <template v-if="!registrationSuccess">
        <form name="user" id="registerForm" @submit.prevent="send" novalidate>
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                <div class="mt-3">
                    <label for="email" class="fs-5">請輸入您的Email</label>
    ...
    <template v-else>
        <div class="d-flex flex-column justify-content-center align-items-center py-8">
            <h2 class="text-center">重設密碼信件發送成功!</h2>
            <h3 class="text-center">請您確認信箱</h3>
