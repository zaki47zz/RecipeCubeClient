...
<template>
    ...
    >
        <div class="container">
            <!-- Logo -->
            <RouterLink class="navbar-brand font-weight-bolder me-auto" to="/" v-bind="$attrs"
            ...
            <!-- RWD的下拉選單按鈕 -->
            <button class="navbar-toggler shadow-none ms-2" type="button" @click="toggleNavbar"
                ...
                <ul class="navbar-nav ms-auto text-center">
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/inventory">
                            <i class="fa-solid fa-box-open opacity-6 me-1" aria-hidden="true"
                    ...
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/buyandcook">
                            <i class="fa-solid fa-utensils opacity-6 me-1" aria-hidden="true"
                                :class="isTransparent ? 'text-white' : 'text-dark'" @click="isNavbarShown = false"></i>
                            隨買隨煮
                        </RouterLink>
                    </li>
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/addingredient">
                            <i class="fa-solid fa-carrot opacity-6 me-1" aria-hidden="true"
                                :class="isTransparent ? 'text-white' : 'text-dark'" @click="isNavbarShown = false"></i>
                            加入食材
                        </RouterLink>
                    </li>
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/customrecipe">
                            <i class="fa-solid fa-pencil opacity-6 me-1" aria-hidden="true"
                                :class="isTransparent ? 'text-white' : 'text-dark'" @click="isNavbarShown = false"></i>
                            自訂食譜
                        </RouterLink>
                    </li>
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/recipe">
                            <i class="fa-solid fa-book-bookmark opacity-6 me-1" aria-hidden="true"
                                :class="isTransparent ? 'text-white' : 'text-dark'" @click="isNavbarShown = false"></i>
                            食譜總覽
                        </RouterLink>
                    </li>
                    <li class="nav-item">
                        <RouterLink class="nav-link me-2" to="/store">
                            <i class="fa-brands fa-shopify opacity-6 me-1" aria-hidden="true"
                                :class="isTransparent ? 'text-white' : 'text-dark'" @click="isNavbarShown = false"></i>
                            食材採購
                        </RouterLink>
                    </li>
